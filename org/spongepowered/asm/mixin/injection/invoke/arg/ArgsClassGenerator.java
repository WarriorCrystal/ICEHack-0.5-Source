...
public final class ArgsClassGenerator implements IClassGenerator {
  ...
  public String getClassName(String paramString) {
    if (!paramString.endsWith(")V"))
      throw new IllegalArgumentException("Invalid @ModifyArgs method descriptor"); 
    String str = (String)this.classNames.get(paramString);
    if (str == null) {
      str = String.format("%s%d", new Object[] { "org.spongepowered.asm.synthetic.args.Args$", Integer.valueOf(this.nextIndex++) });
      this.classNames.put(paramString, str);
    } 
    return str;
  }
